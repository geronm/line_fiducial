...
all: prepare $(LIB_OBJS) $(BUILD_DIR)/line_detection
#$(BUILD_DIR)/main $(BUILD_DIR)/line_detection

# $(BUILD_DIR)/gelsight_depth_driver $(BUILD_DIR)/groundtruth_gen $(BUILD_DIR)/sphere_groundtruth_gen $(BUILD_DIR)/lookup_gen $(BUILD_DIR)/compare_heightmaps
